...
public class MoveChances {
		...
		for (int i = 0; i < 26; i++) {
			...
			if (canMoveO(board, i, d1)) {
				BackgammonBoard board2 = new BackgammonBoard(
						board.placeMoveO(new Move(i, i - d1)));
	...
	private void try2TimesX(int d1, int d2, Collection<PossibleMove> col) {
		...
		for (int i = 0; i < 26; i++) {
			...
			if (canMoveX(board, i, d1)) {
				BackgammonBoard board2 = new BackgammonBoard(
						board.placeMoveX(new Move(i, i + d1)));
	...
	private void try3TimesO(int d1, int d2, int d12,
		...
		for (int a = 0; a < 26; a++) {
			...
			if (canMoveO(board, a, d1)) {
				BackgammonBoard board2 = new BackgammonBoard(
						board.placeMoveO(new Move(a, a - d1)));

				for (int b = 0; b < 26; b++) {
					if (canMoveO(board2, b, d2)) {
						BackgammonBoard board3 = new BackgammonBoard(
								board2.placeMoveO(new Move(b, b - d2)));
	...
	private void try3TimesX(int d1, int d2, int d11,
		...
		for (int a = 0; a < 26; a++) {
			...
			if (canMoveX(board, a, d1)) {
				BackgammonBoard board2 = new BackgammonBoard(
						board.placeMoveX(new Move(a, a + d1)));

				for (int b = 0; b < 26; b++) {
					if (canMoveX(board2, b, d2)) {
						BackgammonBoard board3 = new BackgammonBoard(
								board2.placeMoveX(new Move(b, b + d2)));
						...
						for (int c = 0; c < 26; c++) {
							if (canMoveO(board3, c, d2)) {
								BackgammonBoard board4 = new BackgammonBoard(
										board3.placeMoveO(new Move(c, c - d2)));
				...
				for (int b = 0; b < 26; b++) {
					if (canMoveX(board2, b, d2)) {
						...
						for (int c = 0; c < 26; c++) {
							if (canMoveX(board3, c, d2)) {
								BackgammonBoard board4 = new BackgammonBoard(
										board3.placeMoveX(new Move(c, c + d2)));
